...
bool Climate::set_eco_mode_(ClimateEcoMode mode) {
  return set_alternative(this->eco_mode, mode);
}

bool Climate::set_pellet_rate_(ClimatePelletRate mode) {
  return set_alternative(this->pellet_rate, mode);
}
