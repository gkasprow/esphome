...
INPUTS: dict[str, InputSchema] = {
    ...
    "controller_product_type": InputSchema(
    ...
    "controller_product_version": InputSchema(
    ...
    "opentherm_version_controller": InputSchema(
    ...
    "controller_configuration": InputSchema(
        description="Controller configuration bits",
        unit_of_measurement=UNIT_EMPTY,
        step=1,
        message="CONTROLLER_CONFIG",
        keep_updated=False,
