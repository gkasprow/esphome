...
Logger::Logger(uint32_t baud_rate, size_t tx_buffer_size, int initial_level)
    : baud_rate_(baud_rate), tx_buffer_size_(tx_buffer_size), current_level_(initial_level) {
